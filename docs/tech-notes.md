...
- Two Runs made while proving the above are still listed, "obk probe run for beta" and "obk size probe". Orca offers no way to delete a Run, they belong to nothing, and they can be ignored. The binding checks of 2026-09-24 left "obk probe 228 A", "B", "C" and "S", and the Runs of a throwaway bots folder named `obk bot-father/daily` and `obk p228/…`.
